...
SECRET_KEY = 'django-insecure-7_3$3rsv#%8z9fsbgahk21==x@46*gzx3-#znh%930ry24m-oy'
...
INSTALLED_APPS = [
    ...
    "my_tennis_club.members.apps.MembersConfig"
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'my_tennis_club' / 'my_static_files',
]
